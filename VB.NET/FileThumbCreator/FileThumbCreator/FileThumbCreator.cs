...
{
    public class ThumbnailExtractor : IDisposable, IFileThumbCreator
  {
    ...
    private System.Drawing.Size desiredSize = new System.Drawing.Size(ThumbWidth, ThumbHeight);
    ...
    public virtual System.Drawing.Bitmap GetThumbnail()
    {
        if ((!File.Exists(_filename)) && (!Directory.Exists(_filename)))
      {
        throw new FileNotFoundException(
        String.Format("The file '{0}' does not exist", _filename),
        _filename);
      }
      ...
      if (folder != null)
      {
        ...
        if (pidlMain != IntPtr.Zero)
        {
          ...
          if (item != null)
          {
              string sFileName = Path.GetFileName(_filename);
    ...
    internal ThumbnailExtractor(string file)
    {
        _filename = file;
    }
