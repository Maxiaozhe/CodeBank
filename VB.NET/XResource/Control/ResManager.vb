...
Public Class ResManager
    ...
    Public Shared Function GetMessageResourceManager(ByVal MessageType As Object) As MessageResourcesManager
        ...
        Return MsgManager
    End Function
    Public Shared Function GetString(ByVal type As Type, ByVal Key As String) As String
        Dim resManager As System.Resources.ResourceManager = Nothing
        If mMessageResSet.ContainsKey(type) Then
            resManager = mMessageResSet.Item(type)
            resManager.IgnoreCase = True
        Else
            If HasResources(type) Then
                resManager = New System.Resources.ResourceManager(type)
                resManager.IgnoreCase = True
                mMessageResSet.Add(type, resManager)
            Else
                Return ""
            End If
        End If
