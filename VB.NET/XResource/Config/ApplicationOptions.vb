...
#Region "メソッド"
    ...
    Private Sub InitInstance()
        Me.mIsSign = Convert.ToBoolean(My.Settings.IsSign)
        Me.mSignType = CType(My.Settings.SignType, SignTypes)
        Me.mKeyFilePath = My.Settings.KeyFileName
        Me.mIsBuildPathAuto = Convert.ToBoolean(My.Settings.IsBuildPathAuto)
        If Me.mIsBuildPathAuto = True Then
            Me.mBuildPath = ""
        Else
            Me.mBuildPath = My.Settings.BuildPath
        End If
        Me.mIsOpenDllFolder = Convert.ToBoolean(My.Settings.IsOpenDllFolder)
        Me.mCsvEncode = My.Settings.CSVEncode
        Me.mIsOpenExportFile = Convert.ToBoolean(My.Settings.IsOpenFile)
    ...
    ''' <remarks></remarks>
    Public Sub Save()
        My.Settings.IsSign = Me.mIsSign.ToString()
        My.Settings.SignType = CInt(Me.mSignType).ToString()
        My.Settings.KeyFileName = Me.mKeyFilePath
        My.Settings.IsBuildPathAuto = Me.mIsBuildPathAuto.ToString()
        If Me.mIsBuildPathAuto = True Then
            My.Settings.BuildPath = ""
        Else
            My.Settings.BuildPath = Me.mBuildPath
        End If
        My.Settings.IsOpenDllFolder = Me.mIsOpenDllFolder.ToString()
        My.Settings.CSVEncode = Me.mCsvEncode
        My.Settings.IsOpenFile = Me.mIsOpenExportFile.ToString()
        My.Settings.ImportType = CInt(Me.mImportType).ToString()
