...
Partial Public Class EGGA0001
	...
	<Column(Storage:="_STDOC", DbType:="NVarChar(800)")>  _
	...
	<Column(Storage:="_DTMAKE", DbType:="NVarChar(10)")>  _
	...
	<Column(Storage:="_NMMAKE", DbType:="NVarChar(40)")>  _
	...
	<Column(Storage:="_STMAKE", DbType:="NVarChar(40)")>  _
	...
	<Column(Storage:="_TPACPT", DbType:="NVarChar(32)")>  _
	...
	<Column(Storage:="_DTLASTACPT", DbType:="NVarChar(10)")>  _
	...
	<Column(Storage:="_NMLASTACPT", DbType:="NVarChar(128) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_TPPRIORITY", DbType:="NVarChar(20)")>  _
	...
	<Column(Storage:="_STSUBJECT", DbType:="NVarChar(255)")>  _
	...
	<Column(Storage:="_IDNEXTRECOG", DbType:="Int")>  _
	...
	<Column(Storage:="_IDUNNEXTRECOG", DbType:="Int")>  _
	...
	<Column(Storage:="_NMNEXTRECOG", DbType:="NVarChar(255)")>  _
	...
	<Column(Storage:="_VLSTATUS", DbType:="NVarChar(2)")>  _
	...
	<Column(Storage:="_FGADMIN", DbType:="NVarChar(1)")>  _
	...
	<Column(Storage:="_FGREVISION", DbType:="NVarChar(1)")>  _
	...
	<Column(Storage:="_DTREVISION", DbType:="NVarChar(10)")>  _
	...
	<Column(Storage:="_TMREVISION", DbType:="NVarChar(8)")>  _
	...
	<Column(Storage:="_STCONTROLNO", DbType:="NVarChar(400)")>  _
	...
	<Column(Storage:="_DTRESPONSE", DbType:="NVarChar(10)")>  _
	...
	<Column(Storage:="_STVERSION", DbType:="NVarChar(7)")>  _
	...
	<Column(Storage:="_IDACTINGUSER", DbType:="Int")>  _
	...
	<Column(Storage:="_IDDOCBEFORE", DbType:="Int")>  _
	...
	<Column(Storage:="_FGCUTINTO", DbType:="Int")>  _
	...
	<Column(Storage:="_IDCUTSYSBLG", DbType:="Int")>  _
	...
	<Column(Storage:="_FGBEFORECHK", DbType:="Int")>  _
	...
	<Column(Storage:="_DTDIRECTORDAY", DbType:="DateTime")>  _
	...
	<Column(Storage:="_IDCRESYSBLG", DbType:="Int")>  _
	...
	<Column(Storage:="_VLSTATUSBK", DbType:="NVarChar(32)")>  _
	...
	<Column(Storage:="_VLDOCTYPE", DbType:="NVarChar(1)")>  _
	...
	<Column(Storage:="_VLBBSRELEASE", DbType:="NVarChar(100)")>  _
	...
	<Column(Storage:="_STATUS", DbType:="NVarChar(200)")>  _
	...
	<Column(Storage:="_STATUSUPD", DbType:="NVarChar(10)")>  _
	...
	<Column(Storage:="_STATUSDNP", DbType:="NVarChar(10)")>  _
