...
#End Region
#Region " GetException "
    Public Function GetException(ByVal ExceptType As Object) As RabitFlowException
        Dim msg As String = GetMessage(ExceptType)
        Return New RabitFlowException(ExceptType, msg)
    End Function

    Public Function GetException(ByVal ExceptType As Object, ByVal ParamArray Args() As String) As RabitFlowException
        Dim msg As String = GetMessage(ExceptType, Args)
        Return New RabitFlowException(ExceptType, msg)
    End Function
#End Region
#End Region
